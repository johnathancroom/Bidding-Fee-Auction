...
class AuctionsControllerTest < ActionController::TestCase
  ...
  test "should create auction" do
    assert_difference('Auction.count') do
      post :create, auction: { bidder: @auction.bidder, end_time: @auction.end_time, id: @auction.id, name: @auction.name, price: @auction.price }
    end
  ...
  test "should update auction" do
    put :update, id: @auction, auction: { bidder: @auction.bidder, end_time: @auction.end_time, id: @auction.id, name: @auction.name, price: @auction.price }
    assert_redirected_to auction_path(assigns(:auction))
  end
